...
<body>
        ...
        html_content += f'''
                        <div class="footer">
                            ...
                            <div class="footer-content">
                                <p>🎭 Enjoy your content on <a href="{emby_url}">{emby_owner_name}</a></p>
                                <p>📧 To unsubscribe, contact <a href="mailto:{unsubscribe_email}">{unsubscribe_email}</a></p>
                            </div>
                        </div>
                    </div>
                </td>
    ...
    def _sanitize_string(self, value: str) -> str:
        ...
        if len(sanitized) > 10000:
            ...
            logger.warning(f"String truncated due to length.")
        return sanitized
